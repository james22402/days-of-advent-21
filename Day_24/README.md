...
<div id="sidebar">
<div id="sponsor"><div class="quiet">Our <a href="/2021/sponsors">sponsors</a> help make Advent of Code possible:</div><div class="sponsor"><a href="https://www.hetzner.com/cloud?pk_campaign=adventofcode21&amp;pk_source=adventofcode&amp;pk_medium=website" target="_blank" onclick="if(ga)ga('send','event','sponsor','sidebar',this.href);" rel="noopener">Hetzner</a> - Create your server in seconds &amp; bring your coding vision to life!</div></div>
</div><!--/sidebar-->
